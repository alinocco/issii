"""
Модуль обучения моделей для задачи предсказания тревожности.
...
from .config import FEATURES_KEY, LOCAL_DATA_PATH
...
def train_and_evaluate(
    ...
    with mlflow.start_run(run_name=run_name or model_name):
        ...
        mlflow.log_param("data_local_path", LOCAL_DATA_PATH or "")
        mlflow.log_param("data_features_key", FEATURES_KEY)
